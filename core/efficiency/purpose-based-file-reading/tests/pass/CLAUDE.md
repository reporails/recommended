...
Read files based on purpose to minimize unnecessary context consumption:

- Read full file content when you need to EDIT or refactor it
- Read partial content (first 50 lines) when you need to UNDERSTAND the interface
- For large generated files (protobuf stubs, migrations), read only the relevant section
- Prefer reading the Go doc comments over the full implementation when exploring
